...
export default function Friends() {
  ...
  useEffect(() => {
    const searchUsers = async () => {
      if (searchQuery.length >= 1) { // LinkedIn-style search after 1 character
        try {
              ...
              {loadingRequests ? (
                ...
                <div className="space-y-3">
                  {friendRequests.map((request: any) => {
                    console.log('Incoming friend request data:', request); // Debug log
              ...
              {loadingSent ? (
                ...
                <div className="space-y-3">
                  {sentRequests.map((request: any) => {
                    console.log('Friend request data:', request); // Debug log
                    ...
                    const firstLetter = request.receiverFirstName 
                      ...
                      : request.receiverEmail?.charAt(0).toUpperCase() || request.receiverId.toString().charAt(0).toUpperCase();
